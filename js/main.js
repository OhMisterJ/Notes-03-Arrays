...
- If you need to group relate variables together. */
var store = 'Publix';
...
// Declare an empty array to hold our user's inputs
// var groceries = [];

// Declare three variables that will hold the prompt methods for our user.
// var item1 = prompt('Your first item.');
// var item2 = prompt('Your second item.');
// var item3 = prompt('Your third item.');

// Push the above three variables into our groceries array.
// groceries.push('<br>' + item1 + ', ' + item2 + ', ' + item3);
// document.write(groceries);

// var taco = [];
// var ing1 = prompt('Please enter your first taco ingredient.');
// var ing2 = prompt('Please enter your second taco ingredient.');
// var ing3 = prompt('Please enter your third taco ingredient.');

// taco.push(ing1 + ', ' + ing2 + ', ' + ing3);
// document.write('<br>' + taco);
